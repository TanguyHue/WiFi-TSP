...
\begin{itemize}
    ...
    \item \textbf{Phase 3 (TKIP par trame)} : une fois les clés installées, chaque trame de données est chiffrée indépendamment à l'aide de l'algorithme TKIP. 
...
Un \acrshort{mic} est ensuite calculé sur les données en clair avant chiffrement, puis l'ensemble est chiffré à l'aide de RC4 et transmis.
